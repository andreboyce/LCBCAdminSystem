...
namespace LCBCAdminSystem
{
	...
	/// </summary>
	public ref class Reciepts : public System::Windows::Forms::Form
	{
	public:
		Reciepts(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Reciepts::typeid));
			...
			this->statusStrip->Size = System::Drawing::Size(656, 22);
			...
			this->splitContainer1->Size = System::Drawing::Size(656, 480);
			...
			this->dateTimePicker->Location = System::Drawing::Point(14, 62);
			...
			this->pictureBox1->Location = System::Drawing::Point(318, 10);
			...
			this->label42->Location = System::Drawing::Point(112, 40);
			this->label42->Name = L"label42";
			this->label42->Size = System::Drawing::Size(86, 19);
			this->label42->TabIndex = 15;
			this->label42->Text = L"RECIEPTS";
			// 
			// label43
			// 
			...
			this->label43->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label43->Location = System::Drawing::Point(14, 10);
			...
			this->splitContainer2->Size = System::Drawing::Size(656, 354);
			...
			this->splitContainer3->Size = System::Drawing::Size(656, 294);
			...
			this->listView->Size = System::Drawing::Size(187, 294);
			...
			this->dataGridView->Size = System::Drawing::Size(459, 294);
			this->dataGridView->TabIndex = 2;
			this->dataGridView->CurrentCellChanged += gcnew System::EventHandler(this, &Reciepts::dataGridView_CurrentCellChanged);
			// 
			// buttonSave
			// 
			this->buttonSave->Location = System::Drawing::Point(419, 3);
			this->buttonSave->Name = L"buttonSave";
			this->buttonSave->Size = System::Drawing::Size(75, 23);
			this->buttonSave->TabIndex = 1;
			this->buttonSave->Text = L"Save";
			this->buttonSave->UseVisualStyleBackColor = true;
			this->buttonSave->Click += gcnew System::EventHandler(this, &Reciepts::buttonSave_Click);
			// 
			// buttonPrint
			// 
			this->buttonPrint->Location = System::Drawing::Point(338, 3);
			...
			this->buttonPrint->Click += gcnew System::EventHandler(this, &Reciepts::buttonPrint_Click);
			// 
			// printPreviewDialog
			// 
			...
			// printDocument
			// 
			this->printDocument->PrintPage += gcnew System::Drawing::Printing::PrintPageEventHandler(this, &Reciepts::printDocument_PrintPage);
			// 
			// buttonReload
			// 
			this->buttonReload->Location = System::Drawing::Point(500, 3);
			...
			this->buttonReload->Click += gcnew System::EventHandler(this, &Reciepts::buttonReload_Click);
			// 
			// Reciepts
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(656, 502);
			this->Controls->Add(this->splitContainer1);
			this->Controls->Add(this->statusStrip);
			this->MinimumSize = System::Drawing::Size(424, 429);
			this->Name = L"Reciepts";
			this->Text = L"Reciepts";
			this->Load += gcnew System::EventHandler(this, &Reciepts::Reciepts_Load);
...
#pragma endregion
	...
	private: System::Void Reciepts_Load(System::Object^  sender, System::EventArgs^  e)
	{
	   try
	   {
          LoadPanel( dataAccessClass,   dataGridView,   "Receipt",   listView );
       }
	...
	{
	   LoadFieldValues( dataGridView, listView, dataAccessClass,  "Receipt" );
	}
	private: System::Void buttonSave_Click(System::Object^  sender, System::EventArgs^  e)
	{
		try
		{
		   dataAccessClass->Update( "Receipt" );
		   dataAccessClass->dataSet->AcceptChanges();
		   dataAccessClass->FillDataSet( "Receipt" );
	...
	private: System::Void buttonReload_Click(System::Object^  sender, System::EventArgs^  e)
	{
		try
		{
	       ...
	       dataAccessClass->FillDataSet( "Receipt" );
	       dataGridView->DataSource = dataAccessClass->dataSet->Tables[ "Receipt" ];
		}
		catch( System::Exception^ e )
		{
			using namespace System::Windows::Forms;
