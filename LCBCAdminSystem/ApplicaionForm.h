...
namespace LCBCAdminSystem
{
	...
	/// </summary>
	public ref class ApplicaionForm : public System::Windows::Forms::Form
	{
	public:
		ApplicaionForm(void)
		{
			...
			dataAccessClassParent1   = gcnew LCBCAdminSystem::DataAccessClass();
            dataAccessClassParent2   = gcnew LCBCAdminSystem::DataAccessClass();
			dataAccessClassEmployer1 = gcnew LCBCAdminSystem::DataAccessClass();
			dataAccessClassEmployer2 = gcnew LCBCAdminSystem::DataAccessClass();
			dataAccessClassElder1    = gcnew LCBCAdminSystem::DataAccessClass();
			dataAccessClassElder2    = gcnew LCBCAdminSystem::DataAccessClass();
		}
    ...
    private: LCBCAdminSystem::DataAccessClass^ dataAccessClass, 
		     ^dataAccessClassParent1, ^dataAccessClassParent2, ^dataAccessClassEmployer1, 
			 ^dataAccessClassEmployer2, ^dataAccessClassElder1, ^dataAccessClassElder2;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(ApplicaionForm::typeid));
			...
			this->label7->Location = System::Drawing::Point(9, 171);
			...
			this->splitContainer1->Size = System::Drawing::Size(694, 739);
			...
			this->dateTimePicker->Location = System::Drawing::Point(4, 13);
			...
			this->pictureBoxLogo->Location = System::Drawing::Point(510, 3);
			...
			this->label42->Location = System::Drawing::Point(254, 35);
			this->label42->Name = L"label42";
			this->label42->Size = System::Drawing::Size(169, 19);
			this->label42->TabIndex = 0;
			this->label42->Text = L"APPLICATION FORM";
			// 
			// label43
			// 
			...
			this->label43->Font = (gcnew System::Drawing::Font(L"Times New Roman", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label43->Location = System::Drawing::Point(206, 13);
			...
			this->tabControl1->Size = System::Drawing::Size(694, 628);
			...
			this->tabPage1->Size = System::Drawing::Size(686, 602);
			...
			this->checkBoxBaptised->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxBaptised_CheckedChanged);
			// 
			// label13
			// 
			...
			this->buttonNextPage->Click += gcnew System::EventHandler(this, &ApplicaionForm::buttonNextPage_Click);
			// 
			// groupBox10
			// 
			...
			this->checkBoxAttendedHighSchool->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxAttendedHighSchool_CheckedChanged);
			// 
			...
			this->tabPage2->Size = System::Drawing::Size(686, 602);
			...
			this->buttonPrevious->Click += gcnew System::EventHandler(this, &ApplicaionForm::buttonPrevious_Click);
			// 
			// buttonSubmit
			// 
			this->buttonSubmit->Location = System::Drawing::Point(438, 563);
			...
			this->buttonSubmit->Click += gcnew System::EventHandler(this, &ApplicaionForm::buttonSubmit_Click);
			// 
			...
			this->checkBoxTransferStudent->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxTransferStudent_CheckedChanged);
			// 
			// label47
			// 
			...
			this->checkBoxPlanToGraduate->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxPlanToGraduate_CheckedChanged);
			// 
			// label45
			// 
			...
			this->checkBoxPastArrest->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxPastArrest_CheckedChanged);
			// 
			...
			this->checkBoxUsesIntoxicatingBeverages->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxUsesIntoxicatingBeverages_CheckedChanged);
			// 
			// checkBoxSmokes
			// 
			...
			this->checkBoxSmokes->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxSmokes_CheckedChanged);
			// 
			...
			this->checkBoxUsesIllegalDrugs->CheckedChanged += gcnew System::EventHandler(this, &ApplicaionForm::checkBoxUsesIllegalDrugs_CheckedChanged);
			// 
			// label25
			// 
			...
			this->ClientSize = System::Drawing::Size(694, 739);
			this->Controls->Add(this->splitContainer1);
			this->Controls->Add(this->label7);
			this->Name = L"ApplicaionForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"ApplicaionForm";
...
#pragma endregion
		 ...
		 private: System::Void buttonSubmit_Click(System::Object^  sender, System::EventArgs^  e)
		 {
			 try
			 {
				...
				System::Data::DataRow^ dataRow = dataAccessClass->dataSet->Tables[ "Applicant" ]->NewRow();
				dataRow["ID"]                        = dataAccessClass->dataSet->Tables[ "Applicant" ]->Rows->Count;
				...
				dataAccessClass->dataSet->Tables[ "Applicant" ]->Rows->Add( dataRow );
		 ...
		 private: System::Void checkBoxAttendedHighSchool_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxAttendedHighSchool->Checked == true )
			 {
				 textBoxNameOfHighSchool->Enabled     = true;
				 textBoxAddressOfHighSchool->Enabled  = true;
				 checkBoxCompletedHighSchool->Enabled = true;
			 }
			 else
			 {
				 textBoxNameOfHighSchool->Enabled     = false;
				 textBoxAddressOfHighSchool->Enabled  = false;
				 checkBoxCompletedHighSchool->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxBaptised_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxBaptised->Checked == true )
			 {
				 dateTimePickerDateOfBaptism->Enabled = true;
			 }
			 else
			 {
				 dateTimePickerDateOfBaptism->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxTransferStudent_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxTransferStudent->Checked )
			 {
				 textBoxReasonForTransfer->Enabled = true;
			 }
			 else
			 {
				 textBoxReasonForTransfer->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxUsesIntoxicatingBeverages_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxUsesIntoxicatingBeverages->Checked )
			 {
				 textBoxUsesIntoxicatingBeveragesComment->Enabled = true;
			 }
			 else
			 {
				 textBoxUsesIntoxicatingBeveragesComment->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxSmokes_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxSmokes->Checked )
			 {
				 textBoxSmokerComment->Enabled = true;
			 }
			 else
			 {
				 textBoxSmokerComment->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxUsesIllegalDrugs_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
             if( checkBoxUsesIllegalDrugs->Checked )
			 {
				 textBoxIllegalDrugUserComment->Enabled = true;
			 }
			 else
			 {
				 textBoxIllegalDrugUserComment->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxPastArrest_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxPastArrest->Checked )
			 {
				 textBoxPastArrestComment->Enabled = true;
			 }
			 else
			 {
				 textBoxPastArrestComment->Enabled = false;
			 }
		 }
		 private: System::Void checkBoxPlanToGraduate_CheckedChanged(System::Object^  sender, System::EventArgs^  e)
		 {
			 if( checkBoxPlanToGraduate->Checked )
			 {
				 textBoxExpectedDurationOfStudy->Enabled = true;
			 }
			 else
			 {
				 textBoxExpectedDurationOfStudy->Enabled = false;
			 }
		 }
};
}
